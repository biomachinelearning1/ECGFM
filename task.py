...
class Task(object):
    ...
    def get_batch_iterator(
        ...
        # filter examples that are too large
        print("indices pre "+str(indices))
        if max_positions is not None:
            indices = self.filter_indices_by_size(
                indices, dataset, max_positions, ignore_invalid_inputs
            )
            print("indices post "+str(indices))
        ...
        print("batch_sampler "+str(batch_sampler))

        # return a reusable, sharded iterator
        print("va a llamar a collator, que trabaja con padding_mask")
        print(dataset)
        print("FIN DATASET::::::::::::::::::::::::::::::::::::::::::::::::::")
        ...
        print("fin collator "+str(epoch_iter))
